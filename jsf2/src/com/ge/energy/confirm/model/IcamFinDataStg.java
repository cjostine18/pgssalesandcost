...
/**
 * IcamFinDataStg entity.
 */
@Entity
@Table(name = "CNFM_ICAM_FIN_DATA_STG", schema = "CNFM")
public class IcamFinDataStg extends BaseEntity {

	/**
	 * serialVersionUID long
	 */
	private static final long serialVersionUID = 1L;
	private IcamFinDataStgId id;

	/** default constructor */
	public IcamFinDataStg() {
	}

	/** full constructor */
	public IcamFinDataStg(IcamFinDataStgId id) {
		this.id = id;
	}
	...
	public IcamFinDataStgId getId() {
		return this.id;
	}

	public void setId(IcamFinDataStgId id) {
		this.id = id;
	}
