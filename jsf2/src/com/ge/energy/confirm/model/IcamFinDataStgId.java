/**
 * Project:      PGS - AA
 * Component:    IcamFinDataStgId.java
...
/**
 * IcamFinDataStgId entity.
 */
@Embeddable
public class IcamFinDataStgId implements java.io.Serializable {

	/**
	 * serialVersionUID long
	 */
	private static final long serialVersionUID = 3115244145268110304L;
	...
	/** default constructor */
	public IcamFinDataStgId() {
	}

	/** minimal constructor */
	public IcamFinDataStgId(BigDecimal rollupId, BigDecimal batchId) {
		this.rollupId = rollupId;
		this.batchId = batchId;
	}

	/** full constructor */
	public IcamFinDataStgId(String icamPersistentId, BigDecimal modelId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IcamFinDataStgId))
			return false;
		IcamFinDataStgId castOther = (IcamFinDataStgId) other;
