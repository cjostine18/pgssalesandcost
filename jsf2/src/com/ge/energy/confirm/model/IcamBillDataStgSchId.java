/**
 * Project:      PGS - AA
 * Component:    IcamBillDataStgSchId.java
...
/**
 * IcamBillDataStgSchId entity.
 */
@Embeddable
public class IcamBillDataStgSchId implements java.io.Serializable {
	...
	/** default constructor */
	public IcamBillDataStgSchId() {
	}

	/** minimal constructor */
	public IcamBillDataStgSchId(BigDecimal batchId) {
		this.batchId = batchId;
	}

	/** full constructor */
	public IcamBillDataStgSchId(BigDecimal mdlNum, BigDecimal billYear,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IcamBillDataStgSchId))
			return false;
		IcamBillDataStgSchId castOther = (IcamBillDataStgSchId) other;
